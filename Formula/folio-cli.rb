class FolioCli < Formula
  ...
  on_macos do
    url "https://github.com/CsPS0/folio-cli/releases/download/v1.2.0/folio-cli-macos"
    sha256 "de68ed50ee753824771e77780733e22e8ebe7774eccab5bdc0076b3c00de4c5b"
  end

  on_linux do
    url "https://github.com/CsPS0/folio-cli/releases/download/v1.2.0/folio-cli-linux"
